...
;; Load nano theme
(load-file (concat user-emacs-directory "nano-theme.el"))
...
(use-package projectile
  :ensure t
  :init
  (setq projectile-project-search-path '("~/Documentsprojects/" "~/Documents/writing/sagebrush" "~/Documents/writing/wolfland"))
  :config
...
(use-package org-roam
  ...
  (org-roam-capture-templates
   '(("d" "default" plain
     ...
     ;; PRIMARY SOURCES - filed to sagebrush/04-sources/
...
* Notes"
     ...
     ;; ARCHIVAL ITEM (keeping your existing template but moved to sources folder)
     ("a" "Archival Item (legacy)" plain
      "%?"
      :target (file+head "sagebrush/04-sources/%<%Y%m%d%H%M%S>-${slug}.org"
                         "#+TITLE: ${title}\n#+FILETAGS: :project/sagebrush:source:\n:PROPERTIES:\n:CREATOR: \n:PUBLISHER: \n:DATE: \n:ARCHIVE_NAME: \n:COLLECTION: \n:SERIES: \n:BOX: \n:FOLDER: \n:CALL_NUMBER: \n:ITEM_NUMBER: \n:PEOPLE: \n:ORGANIZATIONS: \n:LOCATIONS: \n:TOPICS: \n:SOURCE_URL: \n:END:\n\n* Abstract / Overview\n\n\n* Images\n\n\n* Transcription\n\n\n* Notes\n\n")
      :unnarrowed t)

     ;; RESEARCH NOTES - filed to sagebrush/03-analysis/
...
#+END_COMMENT"
     ...
     ;; CONCEPT NOTES - filed to sagebrush/03-analysis/
...
* Remaining Questions"
     ...
     ;; HISTORIOGRAPHICAL NOTE - filed to sagebrush/03-analysis/
...
* Remaining Questions/Next Steps"
     ...
     ;; PEOPLE - filed to sagebrush/01-notes/ (keeping your template)
     ("p" "Person" plain
        "%?"
     ...
     ;; SYNTHESIS (keeping your existing template but moved to analysis folder)
  ...
  :bind
  (("C-c w d n" . org-roam-node-find)
   ("C-c w d i" . org-roam-node-insert)
   ("C-c w d f" . org-roam-node-find)
   ("C-c w d l" . org-roam-buffer-toggle)
   ("C-c w d b" . org-roam-buffer-toggle)
   ("C-c w d r" . org-roam-node-rename)
   ("C-c w d k" . org-roam-tag-add)
   ("C-c w d d" . org-roam-dailies-goto-today)
   ("C-c w d c" . org-roam-capture)))
...
;; requires https://github.com/chrisbarrett/nursery
;; see load-file nursery above
